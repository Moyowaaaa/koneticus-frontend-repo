...
const ChatInput = ({ className }: { className?: string }) => {
  return (
    <div className={cn("absolute bottom-0 p-4 w-full left-0", className)}>
      <div className="relative flex items-center rounded-[1.875rem] border border-[#E9E9E9] bg-white p-1 transition-all focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20">
        <Input
