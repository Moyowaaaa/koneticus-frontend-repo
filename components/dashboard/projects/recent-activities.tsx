...
export const RecentActivitiesEmptyState = () => {
  return (
    <div className="h-[25rem] flex items-center justify-center  w-full">
      <p className="text-brand-black text-[0.875rem] dark:text-[#FFFFFF]">
      ...
      <div className="flex flex-col gap-10 w-full pt-6 ">
        <TopBar className="">
          <h1
            className="
          dark:text-[#FFFFFF]
          text-[1.125rem] font-semibold text-brand-black"
          >
            Recent Activities
          </h1>
        </TopBar>
        ...
        <>
          {data.map((activity) => (
            <div
              className="flex w-full  items-center justify-between font-[sora-light] text-[0.875rem] text-brand-black dark:text-[#FFFFFF]"
              key={activity.id}
            >
