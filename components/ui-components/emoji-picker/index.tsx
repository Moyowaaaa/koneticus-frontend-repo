...
export default function EmojiPickerButton({
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent
        className="z-10000 w-[360px] min-w-[360px] overflow-hidden rounded-2xl border border-[#E9E9E9] p-1 shadow-lg duration-0 data-[state=open]:animate-none data-[state=closed]:animate-none dark:border-[#80808026] dark:bg-[#151515]"
        align="end"
        side="top"
        sideOffset={8}
        collisionPadding={12}
        ...
        >
          ...
          >
            ...
            <EmojiPicker.Viewport
              className="relative min-h-0 w-full flex-1 overflow-y-auto overscroll-contain outline-hidden"
              style={{
                width: "100%",
            ...
            >
              ...
              <EmojiPicker.List
                ...
                components={{
                  ...
                  Row: ({ children, ...props }) => (
                    <div
                      className="flex w-full scroll-my-1.5 px-1.5"
                      {...props}
                    >
                      {children}
                    </div>
                  ...
                  Emoji: ({ emoji, ...props }) => (
                    <button
                      type="button"
                      className="flex h-8 min-w-0 flex-1 items-center justify-center rounded-md text-lg transition-colors hover:bg-black/5 data-active:bg-black/5 dark:hover:bg-white/10 dark:data-active:bg-neutral-800"
                      onMouseDown={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                      }}
